...
public class searchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Book> list = BookDAO.getBooks(keyword, searchby);
            if(list !=null && !list.isEmpty()){
                out.println("<!DOCTYPE html>");
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Book Searching</title>");
                ...
                out.println("<tr><td>product id</td><td>name</td><td>price</td><td>imgage</td><td>detail</td><td>action</td></tr>");
                for (Book book : list) {
                    out.println("<tr>");
                    out.println("<td>"+ book.getId()+"</td>");
                    out.println("<td>"+ book.getName()+"</td>");
                    out.println("<td>"+ book.getPrice()+"</td>");
                    out.println("<td><img src='"+ book.getImgpath()+"' class='product'/></td>");
